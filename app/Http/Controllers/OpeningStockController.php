                        ...
                        if (! empty($new_purchase_lines)) {
                            foreach ($new_purchase_lines as $key => $new_purchase_line) {
                                ...
                                $business_locations = BusinessLocation::where('id', $location_id)
                                        ...
                                        "item_purchase_or_sale_price"=>round($purchase_price_inc_tax,2),
                                        "item_purchase_or_sale_currency"=>'BIF',
                                        "item_cost_price"=>round($purchase_price_inc_tax,2),
                                        "item_cost_price_currency"=>'BIF',
                                        "item_movement_type"=>'EN',
                                        "item_movement_description"=>'Opening Stock',
                                        "item_movement_invoice_ref"=>$obrdaterefno,
