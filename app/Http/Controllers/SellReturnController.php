...
class SellReturnController extends Controller
{
    ...
    public function add($id)
    {
       ...
       // $sell->is_full_refund_only = isset($pos_settings['is_full_refund_only']) ? $pos_settings['is_full_refund_only'] : 0;
       
        $sell->is_full_refund_only=1;
       // \Log::info(json_encode($sell->is_full_refund_only));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (! empty($input['products'])) {
                ...
                $invoice = Transaction::where('business_id', $business_id)
                      ->where('return_parent_id', $input['transaction_id'])
                ...
                if (!empty($invoice)) {
                            // $invoice is not empty, proceed with logic here
                            $msg = 'Refund Already done for this invoice';
                     ...
                     //   return redirect()->back();
                            ...
                            // $invoice is empty, handle accordingly
                DB::beginTransaction(); 
