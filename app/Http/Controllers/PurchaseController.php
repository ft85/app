...
class PurchaseController extends Controller
{
    ...
    public function indeximports()
    {
        ...
        $business_id = request()->session()->get('user.business_id');
        if (request()->ajax()) {
            $purchases = $this->transactionUtil->getListimports($business_id);
    ...
    public function store(Request $request)
    {
        ...
        try {
          ...
          //  \Log::info("purchase information.....".json_encode($request->all()));

          $purchases = $request->input('purchases');

         // \Log::info("purchase information.....".json_encode($purchases));
            ...
            foreach ($request->input('purchases') as $item) {
                ...
                $qty = $item['quantity'];
                $price_with_comma = $item['purchase_price'];
            ...
            $obr_stock_movement=  [        
                ...
                "item_movement_description"=>'Normal Purchase',
                "item_movement_invoice_ref"=>$transaction_data['ref_no'],
    ...
    public function getListimports($business_id)
{
    $imports = RRAimports::where('business_id', $business_id)
        ->groupBy('id') // Grouping by 'id' of the 'rra_imports' table
