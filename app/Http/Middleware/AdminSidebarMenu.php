                ...
                $menu->dropdown(
                    ...
                    function ($sub) use ($common_settings) {
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'rra' && request()->segment(2) == null
                            ]
                        );
            ...
            $menu->dropdown('EUCL',
                    function ($sub) use ($common_settings) {
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'vending' && request()->segment(2) == null
                            ]
                        );
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'reg' && request()->segment(2) == null
                            ]
                        );
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'retry' && request()->segment(2) == null
                            ]
                        );

                        $sub->url(
                            route('reg.index2'),
                            'Payment Reciept Copy',
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'copy' && request()->segment(2) == null
                            ]
                        );
                        $sub->url(
                            route('reg.index3'),
                            'Meter Purchase History',
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'meterhistory' && request()->segment(2) == null
                            ]
                        );
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'vhistory' && request()->segment(2) == null
                            ]
                        );

                        $sub->url(
                            route('reg.index5'),
                            'Vendor Account Summmary',
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'vsummary' && request()->segment(2) == null
                            ]
                        );
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'password' && request()->segment(2) == null
                            ]
                        );
                        ...
                        $sub->url(
                            ...
                            [
                                'icon' => '',
                                'active' => request()->segment(1) == 'balance' && request()->segment(2) == null
                            ]
                        );
                    ...
                    ['icon' => '<svg aria-hidden="true" class="tw-size-5 tw-shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  <path d="M13 10V3L4 14h7v7l9-11h-7"></path>
</svg>', 'id' => 'tour_step6']
                )->order(54);
