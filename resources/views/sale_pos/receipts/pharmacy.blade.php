...
<div class="ticket">
				...
				<table border="0"  width="100%" cellpadding = "1" cellspacing = "1">
					<tr>
						...
						<td class="left" valign="top" >
							@if(!empty($rcptsign)) 
							<img src="/img/rra_logo2.png" height="80" width="80">
							@endif
						</td>   
						...
						<td class="right" valign="top">
							@if(!empty($rcptsign)) 
							<img src="/img/RRA_EBMV2.png" height="80" width="80">
							@endif
						</td> 	
					</tr>
				</table>
	        ...
	        @endif
			@if(!empty($receipt_details->customer_group_name))
				<div style="display: flex; color: black; font-size: 14px !important; margin: 0; padding: 0; align-items: center; justify-content: center;">
					<p style="margin: 0; padding: 0;">
						<b>Insurance:</b> {!! $receipt_details->customer_group_name !!}	
					</p>
				</div>	
			@endif

			@if(!empty($receipt_details->customer_group_tin))
				<div style="display: flex; color: black; font-size: 14px !important; margin: 0; padding: 0; align-items: center; justify-content: center;">
					<p style="margin: 0; padding: 0;">
							<b>Insurance TIN:</b> {!! $receipt_details->customer_group_tin !!}
					</p>
				</div>
			@endif
			...
			<div style="display: flex; align-items: center; margin: 0;">
				<div style="flex: 1; border-bottom: 1px dashed black;"></div>
				<span style="padding: 0 10px; font-weight: bold;">Customer</span>
				<div style="flex: 1; border-bottom: 1px dashed black;"></div>
			</div>
			@if(!empty($receipt_details->customer_info))
				<div class="textbox-info" style="text-align: center;">
			...
			@if(!empty($receipt_details->customer_rp_label))
				<div class="textbox-info" style="display: flex; justify-content: space-between;">
			...
			<div style="display: flex; align-items: center; margin: 0;">
				<div style="flex: 1; border-bottom: 1px dashed black;"></div>
				<span style="padding: 0 10px; font-weight: bold;">Remarks</span> 
				<div style="flex: 1; border-bottom: 1px dashed black;"></div>
			</div>
			<div class="textbox-info" style="display: flex; justify-content: center; text-align: center;">
				...
				<tbody>
					...
					<tr class="bb-lg">
						<td class="description">
							<div style="display: flex; color: black; font-size: 14px !important; margin: 0; padding: 0; align-items: center;">
								<p style="margin: 0; padding: 0;">
									#{{$loop->iteration}}.&nbsp;{{$line['name']}}								
									@if(!empty($line['brand'])), {{$line['brand']}} @endif
									@if(!empty($line['product_description']))({{ strip_tags($line['product_description']) }}) @endif
							...
							<div style="display:flex; color: black; font-size: 14px !important;">
								<p class="text-left width-40 quantity m-0 bw" style="direction: ltr; margin-top: 0; margin-bottom: 0;">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {{$line['lot_number_label']}} & {{$line['product_expiry_label']}}:
								</p>
								<p class="text-right width-60 price m-0 bw" style="white-space: nowrap; margin-top: 0; margin-bottom: 0;">
									{{$line['lot_number']}} 
							...
							<div style="display:flex; color: black; font-size: 14px !important;">
								<p class="text-left width-60 quantity m-0 bw" style="direction: ltr; margin-top: 0; margin-bottom: 0;">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									@if(empty($receipt_details->hide_price))<b>{{$line['unit_price_inc_tax']}}</b>
		...
		<table border="0"  width="100%" cellpadding = "1" cellspacing = "1">    
			...
			<tr>
				...
				<td class="right" style="white-space: nowrap;">{{$receipt_details->rcptNo."/".$receipt_details->rcptNo." NS"}}</td>
			</tr> 
			<tr>
...
<tr>             
    <td colspan="2" class="center" style="font-size: 12px;">
        ...
        @endphp
			...
			<tr>
				<td class="left" style="white-space: nowrap;">RECEIPT NUMBER:</td>
				<td class="right">{{ $receipt_details->rcptNo }}</td>
			</tr> 
			<tr>
	...
	<table border="0"  width="100%" cellpadding = "1" cellspacing = "1">
			...
			<tr><TD class="center">Tel: 0783599370</td></tr>
	</table>
