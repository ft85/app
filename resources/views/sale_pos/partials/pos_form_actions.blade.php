    ...
    <div
        ...
        <div
            ...
            <div class="tw-flex tw-items-center tw-gap-4 tw-flex-row tw-overflow-x-auto">
                ...
                @php
                    $buttonData = app()->make('App\Http\Controllers\SellPosController')->showButton();
                @endphp

                @if($buttonData['showOrderLinesButton'])
                    {!! $buttonData['view'] !!}
                @endif
...
<!-- @include('sale_pos.partials.orderlines_modal') -->
...
<script>
    $(document).ready(function() {
        ...
        function loadModalContent() {
            $.ajax({
                method: 'GET',
                url: '/user-line-orders', // Adjust the URL as needed
                success: function(data) {
                    $('#modalBodyContent').html(data);
                },
                error: function(xhr, status, error) {
                    toastr.error('An error occurred while loading the modal content: ' + error);
                },
            });
        }
        ...
        // Event delegation for Print Button Click
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        ...
                        // Print and then reload modal content
                        iframe.onload = function() {
                            iframe.contentWindow.focus();
                            iframe.contentWindow.print();
                            // After printing, reload modal content
                            loadModalContent();
                        };
                    } else {
        ...
        // Event delegation for Serve Button Click
        $(document).on('click', '.serve-btn', function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.success) {
                        toastr.success(result.msg);
                        // Reload modal content instead of the entire page
                        loadModalContent();
                    } else {
                        toastr.error(result.msg);
                    }
