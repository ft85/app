                    ...
                    <div class="tw-dw-menu tw-w-2/4 tw-min-h-full tw-bg-white tw-p-6">
                        ...
                        <div class="row tw-mr-5">
                            ...
                            @foreach ($categories as $category)
                                    ...
                                    <div class="col-md-3 col-xs-12 tw-mb-5 tw-w-auto  tw-h-auto  tw-cursor-pointer main-category no-print " data-name="{{ $category['name'] }}">
                                        <div class="tw-dw-card tw-w-25 tw-bg-base-100 tw-shadow-sm tw-h-auto tw-shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] tw-bg-white hover:tw-bg-white/60 tw-cursor-pointer tw-text-xs md:tw-text-sm tw-font-semibold !tw-text-center tw-border-2">
                                            <div class="tw-dw-card-body">
                                            ...
                                            <div class="tw-dw-card-actions tw-justify-center">
                                                <button type="button" class="tw-dw-btn tw-dw-btn-accent tw-dw-btn-outline tw-dw-btn-sm  product_category tw-mb-2" data-value="{{ $category['id'] }}" data-parent="0">All</button>
                                                @if (!empty($category['sub_categories']))
                                                <button type="button" class="tw-dw-btn tw-dw-btn-primary tw-dw-btn-outline tw-dw-btn-sm main-category tw-mb-2"  data-value="{{ $category['id'] }}"  data-name="{{ $category['name'] }}">Next »</button>
                                                @endif
                                            </div>
