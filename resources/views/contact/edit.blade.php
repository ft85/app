            ...
            <div class="row">
                ...
                <div class="col-md-4 mt-15">
                    <label class="radio-inline">
                        <input type="radio" name="contact_type_radio"
                               @if($contact->contact_type == 'individual') checked @endif id="inlineRadio1"
                               value="individual">
                ...
                @if($is_pharmacy)
                    <div class="col-md-4 customer_fields">
                        <div class="form-group">
                            {!! Form::label('customer_group_id', __('Insurance Company') . ':') !!}
                            <div class="input-group">
                  <span class="input-group-addon">
                ...
                <!-- Pharmacy-specific fields, shown only if is_pharmacy is true -->
                @if($is_pharmacy)


                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('co_pay', 'Co-Pay (%):') !!}
                            {!! Form::number('co_pay', $contact->co_pay, ['class' => 'form-control', 'placeholder' => 'Co-Pay (%)', 'step' => '0.01']); !!}
                        </div>
                    </div>
                @endif
                ...
                <div class="col-md-3 individual"
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text('first_name', $contact->first_name, ['class' => 'form-control', 'placeholder' => __( 'business.first_name' ) ]); !!}
                    </div>
                </div>
                <div class="col-md-3 individual"
                     @if($contact->contact_type == 'business' || empty($contact->contact_type)) style="display: none;" @endif>
