            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('username', $location->username, ['class' => 'form-control', 'required', 'placeholder' => __('Username')]) !!}
                    </div>  
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">
                            {{ __('Leave blank if you do not wish to update the password.') }}
                        </small>
                    </div>  
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                            <label class="btn btn-outline-primary flex-fill">
                                {!! Form::radio('tva_payer', '1', $location->tva_payer == '1', ['autocomplete' => 'off']) !!} Oui
                            </label>
                            <label class="btn btn-outline-primary flex-fill">
                                {!! Form::radio('tva_payer', '0', $location->tva_payer == '0', ['autocomplete' => 'off']) !!} Non
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                            <label class="btn btn-outline-primary flex-fill">
                                {!! Form::radio('tc_payer', '1', $location->tc_payer == '1', ['autocomplete' => 'off']) !!} Oui
                            </label>
                            <label class="btn btn-outline-primary flex-fill">
                                {!! Form::radio('tc_payer', '0', $location->tc_payer == '0', ['autocomplete' => 'off']) !!} Non
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle d-flex" data-toggle="buttons">
                            <label class="btn btn-outline-primary flex-fill">
                                {!! Form::radio('pfa_payer', '1', $location->pfa_payer == '1', ['autocomplete' => 'off']) !!} Oui
                            </label>
                            <label class="btn btn-outline-primary flex-fill">
                                {!! Form::radio('pfa_payer', '0', $location->pfa_payer == '0', ['autocomplete' => 'off']) !!} Non
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select('custom_field3', ['DPMC' => 'DPMC', 'DMC' => 'DMC', 'DGC' => 'DGC'], $location->custom_field3, ['class' => 'form-control', 'placeholder' => $location_custom_field3]) !!}
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="form-group">
