			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::select('discount_type', [ '' => __('lang_v1.none'), 'fixed' => __( 'lang_v1.fixed' ), 'percentage' => __( 'lang_v1.percentage' )], $discount_type, ['class' => 'form-control', 'disabled' => 'disabled']); !!}
						{!! Form::hidden('discount_type', $discount_type) !!}
					</div>
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						{!! Form::text('discount_amount', @num_format($discount_amount), ['class' => 'form-control input_number', 'readonly' => 'readonly']) !!}
					</div>
					
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						{!! Form::label('refundreason','Refund Reason', ':') !!}
						{!! Form::select('refundreason', [
						'' => __('lang_v1.none'),
						'01' => 'Missing Quantity',
						'02' => 'Missing Item',
						'03' => 'Damaged',
						...
						'12' => 'Wrong tax type',
						'13' => 'Other reason'
					], $refundreason ?? '', ['class' => 'form-control', 'required' => 'required']) !!}
