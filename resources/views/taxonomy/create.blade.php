<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('Item Class Code') !!}
        <br>
        {!! Form::select('unspec', $codes, !empty($duplicate_product->category_id) ? $duplicate_product->category_id :
        null, [
      ...
      <div class="form-group">
        ...
        {!! Form::select('printer', $formatted_printers, null, ['class' => 'form-control', 'placeholder' => __('Select Printer')]) !!}
      </div>
      @if($cat_code_enabled)
      <div class="form-group">
