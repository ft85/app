    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <div class="checkbox">
                    <label>
     {!! Form::checkbox('pos_settings[is_full_refund_only]', 1, !empty($pos_settings['is_full_refund_only']) , [ 'class' => 'input-icheck', 'id' => 'is_full_refund_only']); !!} {{ __( 'lang_v1.is_full_refund_only' ) }}
                    </label>
                </div>
            </div>
        </div>
