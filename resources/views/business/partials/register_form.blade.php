...
<fieldset>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('is_pharmacy', __('Is Pharmacy') . ':*') !!}
            <div class="input-group">
            <span class="input-group-addon">
                 <i class="fa fa-medkit"></i>
            </span>
                {!! Form::select('is_pharmacy', [1 => __('Yes'), 0 => __('No')], null, ['class' => 'form-control', 'placeholder' => __('Select Is Pharmacy '), 'required']) !!}
            </div>
        </div>
    </div>
    <div class="col-md-6">
...
@if(empty($is_admin))
    ...
    <fieldset>
        ...
        <div class="col-md-6">
            <div class="form-group">
                {!! Form::label('fy_start_month', __('business.fy_start_month') . ':*') !!} @show
                _tooltip(__('tooltip.fy_start_month'))
                <div class="input-group">
                <span class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                </span>
