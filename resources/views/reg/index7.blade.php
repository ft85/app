@extends('layouts.app')
@section('title', 'Payment Retry')

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Payment Retry
    </h1>
</section>
...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary', 'title' => __('Payment Retry')])
