                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            'adjustment_type',
                            [
                                'obsolete' => __('Obsolete/Expired'),
                                'stolen' => __('Stolen Items'),
                                'damaged' => __('Damaged/Breakage Items'),
                                'loss' => __('Loss'),
                                'adjustment_issues' => __('Adjustment issues'),
                                'adjustment_entries' => __('Adjustment entries'),
                                'inventory' => __('Inventory'),
                                'other_entries' => __('Other entries'),
                                'others' => __('Others'),
                            ],
                            null,
